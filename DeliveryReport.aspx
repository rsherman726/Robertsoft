<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DeliveryReport.aspx.cs" Inherits="DeliveryReport" %>
                            ...
                            <tr>
                                <td class="hdr" align="center">
                                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="X-Large"
                                        Text="Delivery/Will Call Report"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>
                                                                        ...
                                                                        <asp:GridView ID="gvRecord" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="Black" Width="1150px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" OnPageIndexChanging="gvRecord_PageIndexChanging" OnRowDataBound="gvRecord_RowDataBound" OnRowCommand="gvRecord_RowCommand" OnSorting="gvRecord_Sorting" AllowSorting="True" PageSize="50" ShowFooter="True" Font-Size="7pt" ShowHeader="False">
                                                                            ...
                                                                            <Columns>                                                                                
                                                                                <asp:TemplateField HeaderText="SO #" SortExpression="SalesOrder">
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <asp:LinkButton ID="lbnSalesOrder" runat="server" Text='<%# Bind("SalesOrder") %>'
                                                                                            CommandName="Select" ToolTip="Click to view Details."
                                                                                            CommandArgument='<%# ((GridViewRow) Container).RowIndex %>'
                                                                                            ForeColor="#00569D" CssClass="NoUnderline" Font-Size="8" Font-Bold="True" Width="41"></asp:LinkButton>
                                                                                    </ItemTemplate>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Order Date" SortExpression="OrderDate">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblOrderDate" runat="server" Text='<%# Bind("OrderDate") %>' Font-Bold="false" Font-Size="8" Width="65px"></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                                                </asp:TemplateField>                                                                                
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Requested<br/> Ship Date" SortExpression="reqShipDate">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblShipDate" runat="server" Text='<%# Bind("reqShipDate") %>' Font-Bold="false" Font-Size="8" Width="62px"></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" />
                                                                                </asp:TemplateField>                                                                             
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Delivery/<br>Will Call<br/>Status" SortExpression="DeliveryStatus">
                                                                                    <ItemTemplate>
