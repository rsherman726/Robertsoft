<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ShipViaAdmin.aspx.cs" Inherits="ShipViaAdmin" MaintainScrollPositionOnPostback="true" %>
                            ...
                            <tr>
                                <td class="hdr" align="center">
                                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="X-Large"
                                        Text="Ship Via Admin" ForeColor="Black"></asp:Label></td>
                            </tr>
                            <tr>
                                    ...
                                    <asp:Panel ID="pnlMain" runat="server" Width="700px">
                                        <table align="center" style="border-right: #000000 0px solid; border-top: #000000 0px solid; border-left: #000000 0px solid; border-bottom: #000000 0px solid; background-color: ghostwhite" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td align="left">
                                                    <asp:ListBox ID="lbShipVia" runat="server" AutoPostBack="True" BackColor="LemonChiffon" CssClass="form-control" Font-Bold="True" Font-Size="10pt" ForeColor="Black" Height="200px" OnSelectedIndexChanged="lbShipVia_SelectedIndexChanged"></asp:ListBox>
                                                </td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td align="center">
                                                    <asp:Label ID="lblView" runat="server" Font-Bold="True" Font-Italic="True" ForeColor="Black" Text="VIEW SHIP VIA:"></asp:Label>
                                                </td>
                                                <td align="center">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">&nbsp;</td>
                                                <td align="left">
                                                    <asp:Label ID="Label35" runat="server" Font-Bold="True" ForeColor="Black" Text="SHIP VIA:"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtShipVia" runat="server" BackColor="LemonChiffon" BorderWidth="2px" CssClass="form-control" Font-Size="12pt" ForeColor="Black"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtShipVia" EnableClientScript="False" ErrorMessage="Ship Via is required." ValidationGroup="emp"><img src="Images/arrow_alert.gif" alt="arrow"/></asp:RequiredFieldValidator>
                                                </td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
