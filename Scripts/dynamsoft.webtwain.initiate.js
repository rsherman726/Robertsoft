...
var Dynamsoft = (function () {
	...
	var ua = (navigator.userAgent.toLowerCase()),
		...
		DWTProduct : {
			...
			_strVersionCode: '9,1', 				// The version of DWT. ActiveX will use this to determine if it is necessary to upgrade the client. Use ',' to separate the numbers. 		
...
(function(D) {
    ...
    SWebTwain.prototype._init = function(configs) {
        ...
        if (configs.onGetFilePath) {
            swt._onGetFilePath = configs.onImageAreaDeSelected;
        }
    };
    ...
    SWebTwain.prototype._attachEvents = function () {
        ...
        try {
            ...
            if (Dynamsoft.Env._bInIE) {
                var wt = this;
                if (wt._onPostTransfer != '' || wt._onPostTransfer != null)
                    wt._objectWebTwain.attachEvent('onPostTransfer', wt._onPostTransfer);
                if (wt._onPostAllTransfers != '')
                    wt._objectWebTwain.attachEvent('onPostAllTransfers', wt._onPostAllTransfers);
                if (wt._onMouseClick != '')
                    wt._objectWebTwain.attachEvent('onMouseClick', wt._onMouseClick);
                if (wt._onPostLoad != '')
                    wt._objectWebTwain.attachEvent('onPostLoad', wt._onPostLoad);
                if (wt._onImageAreaSelected != '')
                    wt._objectWebTwain.attachEvent('onImageAreaSelected', wt._onImageAreaSelected);
                if (wt._onMouseDoubleClick != '')
                    wt._objectWebTwain.attachEvent('onMouseDoubleClick', wt._onMouseDoubleClick);
                if (wt._onMouseRightClick != '')
                    wt._objectWebTwain.attachEvent('onMouseRightClick', wt._onMouseRightClick);
                if (wt._onTopImageInTheViewChanged != '')
                    wt._objectWebTwain.attachEvent('onTopImageInTheViewChanged', wt._onTopImageInTheViewChanged);
                if (wt._onImageAreaDeSelected != '')
                    wt._objectWebTwain.attachEvent('onImageAreaDeSelected', wt._onImageAreaDeSelected);
                if (wt._onGetFilePath != '')
                    wt._objectWebTwain.attachEvent('onGetFilePath', wt._onGetFilePath);
            }
    ...
    SWebTwain.prototype._firefoxEvents = function() {
