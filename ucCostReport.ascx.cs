...
public partial class ucCostReport : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["sc"] != null && Request.QueryString["start"] != null && Request.QueryString["end"] != null && Request.QueryString["period"] != null)
            {

                txtStartDate.Text = Request.QueryString["start"].ToString();
                txtEndDate.Text = Request.QueryString["end"].ToString();
                ddlPeriod.SelectedValue = Request.QueryString["period"].ToString();
                txtStockCode.Text = Request.QueryString["sc"].ToString().Trim();


                RunReport(Request.QueryString["sc"].ToString().Trim());
            }
    ...
    {//1st Level...
        ...
        switch (e.CommandName)
        {
            case "Select":
                ...
                lblDetailsForJob.Text = "Details for Job <font color='Blue'><b>" + lblParentJob.Text + "</b></font>  (<font color='Red'><b>" + lblDate.Text + "</b></font>) - (<font color='blue'><b>" + lbnStockCode.Text + "</font></b>) <font color='Navy'><b>" + lblDescription.Text + "</b></font>";
    ...
    {//2nd Level...
        ...
        switch (e.CommandName)
        {
            case "Select":
                ...
                sSQL = "EXEC spGetWipCostAnalysis ";
                sSQL += "@FromJob='" + lblRecipeJob.Text + "'";
                Debug.WriteLine(sSQL);
                dtIng = SharedFunctions.getDataTable(sSQL, conn, "dtReportIng");
                ...
                if (dtIng.Rows.Count > 0)
                {
                    ...
                    lblDetailsForJob2.Text = "Details for Job <font color='Blue'><b>" + lblRecipeJob.Text + "</b></font> Qty: <font color='Red'><b>" + lblQty.Text + "</b></font> PanSize: <font color='Red'><b>" + lblPanSize.Text + "</b></font> - (<font color='blue'><b>" + lbnStockCode.Text + "</font></b>)  <font color='Navy'><b>" + lblDescription.Text + "</b></font>";
