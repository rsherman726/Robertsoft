<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CustomerReportsForSalesperson.aspx.cs" Inherits="CustomerReportsForSalesperson" MaintainScrollPositionOnPostback="true" %>
                                        ...
                                        <tr>
                                            <td>
                                                <table>
                                                                        ...
                                                                        <table width="730">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    &nbsp;</td>
                                                                                <td align="center">
                                                                                    <asp:Button ID="btnEndCustomerPanel" runat="server" CssClass="btn btn-info" Text="END CUSTOMER" ToolTip="End Customer Search" Width="200px" OnClick="btnEndCustomerPanel_Click" />
                                                                                </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <table width="100%">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center">
                                                                                                    <asp:TextBox ID="txtStockCodeFrom" runat="server" BackColor="LemonChiffon" CssClass="form-control" Font-Bold="True" Font-Size="12pt" ForeColor="Black" ValidationGroup="" Width="300px" placeholder="StockCode From">000000</asp:TextBox>
                                                        ...
                                                        <td align="left" valign="top">
                                                            <table style="width: 550px">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:ListBox ID="lbZips" runat="server" BackColor="LemonChiffon" CssClass="form-control" ForeColor="Black" Height="100px" SelectionMode="Multiple"></asp:ListBox>
                                                                    </td>
                                                                    <td align="left">&nbsp;</td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td align="left" valign="top">
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:DropDownList ID="ddlYearsBack" runat="server" AutoPostBack="True" BackColor="LemonChiffon" CssClass="form-control" Font-Bold="True" Font-Size="9pt" ForeColor="Black" OnSelectedIndexChanged="ddlYearsBack_SelectedIndexChanged" Width="100px">
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top">
                                                            <asp:LinkButton ID="lbnTrendsReport" runat="server" ForeColor="White" OnClick="lbnTrendsReport_Click" CssClass="btn btn-success">Purchasing Trends Report ($)</asp:LinkButton>
                                                            <asp:LinkButton ID="lbnTrendsReportByQty" runat="server" CssClass="btn btn-success" ForeColor="White" OnClick="lbnTrendsReportByQty_Click">Purchasing Trends Report (Qty)</asp:LinkButton>
                                                            &nbsp;
                                                             <br />
                                                            <asp:Label ID="label1" runat="server" CssClass="Text_Small" EnableViewState="False" Font-Bold="True" Font-Size="8pt" ForeColor="Red">**It&#39;s recommended you run Trends Report after Customer Report</asp:Label>
                                                            <br />
                                                ...
                                                <div id="DivData" class="Container" style="vertical-align: top; height: 300px; width: 1350px;">
                                                    <asp:GridView ID="gvReportCondensed" runat="server" AutoGenerateColumns="False" Font-Size="10pt"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Desc" SortExpression="Description">
                                                                <HeaderStyle BackColor="#333333" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" CssClass="CenterAligner" />
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Uom">
                                                                <HeaderStyle BackColor="#333333" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" CssClass="CenterAligner" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUom" runat="server" Text='<%# Bind("CostUom") %>' Width="65px"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Amount" SortExpression="Amount">
                                                                <HeaderStyle BackColor="#333333" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" CssClass="CenterAligner" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblAmount" runat="server" Text='<%# Bind("Amount") %>' Width="95px"></asp:Label>
                                                                    <asp:Label ID="lblCostValue" runat="server" Text='<%# Bind("CostValue") %>' Visible="false"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Price<br/> Change<br/> Date">
                                                                <HeaderStyle BackColor="#333333" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" CssClass="CenterAligner" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblLastChangeDate" runat="server" Text='<%# Bind("LastChangeDate") %>' Width="95px"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="YTD" SortExpression="CurrentYTD">
                                                                <HeaderStyle BackColor="#333333" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" CssClass="CenterAligner" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblYTD" runat="server" Text='<%# Bind("CurrentYTD") %>' Width="95px"></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="right" Width="85px" />
                                                                <FooterTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Year - 1">
                                                                ...
                                                                <ItemStyle HorizontalAlign="right" Width="85px" />
                                                                <FooterTemplate>
                                                                    <asp:Label ID="lblYearMinus1Total" runat="server" Text="$0.00" Width="95px"></asp:Label>
                                                                </FooterTemplate>
                                                                <FooterStyle HorizontalAlign="right" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Year - 2">
                                                                ...
                                                                <ItemStyle HorizontalAlign="right" Width="85px" />
                                                                <FooterTemplate>
                                                                    <asp:Label ID="lblYearMinus2Total" runat="server" Text="$0.00" Width="95px"></asp:Label>
                                                                </FooterTemplate>
                                                                <FooterStyle HorizontalAlign="right" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Year - 3">
                                                                ...
                                                                <ItemStyle HorizontalAlign="right" Width="85px" />
                                                                <FooterTemplate>
                                                                    <asp:Label ID="lblYearMinus3Total" runat="server" Text="$0.00" Width="95px"></asp:Label>
                                                                </FooterTemplate>
                                                                <FooterStyle HorizontalAlign="right" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Year - 4">
                                                                ...
                                                                <ItemStyle HorizontalAlign="right" Width="85px" />
                                                                <FooterTemplate>
                                                                    <asp:Label ID="lblYearMinus4Total" runat="server" Text="$0.00" Width="95px"></asp:Label>
                                                                </FooterTemplate>
                                                                <FooterStyle HorizontalAlign="right" />
                                                            </asp:TemplateField>
                            ...
                            <td align="center">
                                ...
                                <asp:GridView ID="gvCustomerSummary" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Amount" SortExpression="RangeAmount">
                                            <HeaderStyle BackColor="#333333" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" CssClass="CenterAligner" />
                                            <ItemTemplate>
                        ...
                        <tr>
                            <td align="center">
                                <table id="Table1" align="center">
                                    <tr>
                                        <td align="center">
                                            <asp:LinkButton ID="btnExportFullReport" runat="server" CssClass="btn btn-success" ForeColor="White" OnClick="btnExportFullReport_Click" Width="275px"><i class="glyphicon glyphicon-export"></i></i>&nbsp;EXPORT TO EXCEL FULL REPORT</asp:LinkButton>
                                            <asp:LinkButton ID="btnExportSummary" runat="server" CssClass="btn btn-success" ForeColor="White" OnClick="btnExportSummary_Click" Width="275px"><i class="glyphicon glyphicon-export"></i></i>&nbsp;EXPORT TO EXCEL SUMMARY</asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                            </td>
