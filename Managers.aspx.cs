...
public partial class Managers : System.Web.UI.Page
{
    ...
    protected void gvRecord_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string code = "window.open('ManagersProductionInput.aspx?job=" + lblJob.Text + "','_blank','left=500, top=5, height=990, width=1024, status=no, resizable= no, scrollbars= yes, toolbar= no,location= no, menubar= no');";
