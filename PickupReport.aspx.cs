...
public partial class PickupReport : System.Web.UI.Page
{
            ...
            if (lblDeliveryStatus.Text != "")
            {
                switch (lblDeliveryStatus.Text)
                {
                    case "1":
                        ...
                        break;
                    case "2":
                        lblDeliveryStatus.Text = "Delivery Completed";
                        break;
                    case "3":
                        lblDeliveryStatus.Text = "PickUp Scheduled";
                        break;
                    case "4":
                        lblDeliveryStatus.Text = "Delivery Scheduled";
                        break;
                    default:
    ...
    protected void gvRecord_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case "Scan"://Goes to pre scan...
                ...
                Response.Redirect("PreScan.aspx?id=" + lblDeliveryID.Text + "&type=PK");
                break;
        }
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        for (int x = 0; x < gvRecord.Columns.Count; x++)
        {
            ...
            {
                case 0://Internal PO#
                    headerCell.Width = Unit.Pixel(76);
                    break;
                case 1://Customer
                    headerCell.Width = Unit.Pixel(169);
                    break;
                case 2://CustID
                    headerCell.Width = Unit.Pixel(64);
                    break;                    
                case 3://DeliveryID
                ...
                case 4://Type
                    ...
                    break;
                case 5://Date Scheduled
                    headerCell.Width = Unit.Pixel(81);
                    break;
                case 6://Date Delivered
                    headerCell.Width = Unit.Pixel(81);
                    break;
