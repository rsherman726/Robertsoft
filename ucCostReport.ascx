<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCostReport.ascx.cs" Inherits="ucCostReport" %>
...
<table align="center" width="900">
    ...
    <tr>
        <td align="center">
            <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Cost Report"></asp:Label>
        </td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td style="height: 350px">
            <asp:Panel ID="pnlSearchCriteria" runat="server">
                <table width="100%" class="JustRoundedEdgeBothSmall" style="background-color: lightblue;">
                    <tr>
                        <td align="left">
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <asp:TextBox ID="txtStartDate" runat="server"
                                                                    ValidationGroup="" BackColor="LemonChiffon" CssClass="form-control" Font-Bold="True" Font-Size="12pt" ForeColor="Black"></asp:TextBox>
                        ...
                        <asp:Panel ID="pnlGridView" runat="server" Height="300px" ScrollBars="Vertical" Visible="False">
                            <div id="DivData" class="Container" style="vertical-align: top; height: 300px; width: 1010px;">
                                <asp:GridView ID="gvReportCondensed" runat="server" AutoGenerateColumns="False" Font-Size="10pt"
                                    ...
                                    BorderWidth="1px" ForeColor="Black" OnRowDataBound="gvReportCondensed_RowDataBound" OnRowCommand="gvReportCondensed_RowCommand" Font-Names="Arial">
