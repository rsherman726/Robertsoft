<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CustomerReportsForSalespersonShorted.aspx.cs" Inherits="CustomerReportsForSalespersonShorted" %>
            ...
            <div>
                <div>
                    <table align="center" width="1200">
                            ...
                            <td style="background-color: lightblue;" align="center" class="JustRoundedEdgeBothSmall">
                                <asp:Panel ID="pnlSearchCriteria" runat="server" Width="1400px">
                                    <table width="1400">
                                                                    ...
                                                                    <td align="center">
                                                                        <table width="730">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Button ID="btnSingleStockCodePanel" runat="server" CssClass="btn btn-info btn-sm" Text="SINGLE STOCKCODE" ToolTip="Single StockCode Search" Width="200px" OnClick="btnSingleStockCodePanel_Click" />
                                                                                </td>
                                                                                <td>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:Button ID="btnPreview" runat="server" CssClass="btn btn-info" OnClick="btnPreview_Click" Text="Full Report" />
                                                <asp:Button ID="btnSummary" runat="server" CssClass="btn btn-info" OnClick="btnSummary_Click" Text="Summary" />
                                                <asp:Button ID="btnReset" runat="server" CssClass="btn btn-danger" OnClick="btnReset_Click" Text="Reset Form" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <tr>
                            <td align="center">
                                <asp:Label ID="Label79" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="14pt" ForeColor="Navy" Text="Shorted Full"></asp:Label></td>
                        </tr>
                                    ...
                                    <tr class="rowColors">
                                        <td align="left">
                                            <asp:Panel ID="pnlGridView" runat="server" Height="300px" ScrollBars="Vertical" Visible="False">
                                                <div id="DivData" class="Container" style="vertical-align: top; height: 300px; width: 1475px;">
                                                    <asp:GridView ID="gvReportCondensed" runat="server" AllowSorting="false" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Font-Names="Arial" Font-Size="10pt" ForeColor="Black" GridLines="Vertical" OnRowDataBound="gvReportCondensed_RowDataBound" OnSorting="gvReportCondensed_Sorting" ShowFooter="True" ShowHeader="False">
                                                        <AlternatingRowStyle BackColor="WhiteSmoke" />
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Name" SortExpression="Name">
                                                                <HeaderStyle BackColor="#333333" CssClass="CenterAligner" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName" runat="server" Font-Size="8pt" Text='<%# Bind("Name") %>' Width="200px"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Sales&lt;br/&gt;Person" SortExpression="SalesPerson">
                                                                <HeaderStyle BackColor="#333333" CssClass="CenterAligner" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSalesPerson" runat="server" Font-Size="7" Text='<%# Bind("SalesPerson") %>' Width="100px"></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="center" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Stock&lt;br/&gt;Code" SortExpression="StockCode">
                                                                <HeaderStyle BackColor="#333333" CssClass="CenterAligner" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" />
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lbnStockCode" runat="server" CausesValidation="False" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CommandName="Select" Font-Bold="True" Font-Size="8" ForeColor="Navy" Text='<%# Bind("StockCode") %>' ToolTip="Click to view Details." Width="90px"></asp:LinkButton>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="center" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Description" SortExpression="Description">
                                                                <HeaderStyle BackColor="#333333" CssClass="CenterAligner" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDescription" runat="server" Font-Size="7pt" Text='<%# Bind("Description") %>' Width="100px"></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="center" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Product Class" SortExpression="PCDescription">
                                                                <HeaderStyle BackColor="#333333" CssClass="CenterAligner" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProductClass" runat="server" Font-Size="7pt" Text='<%# Bind("PCDescription") %>' Width="100px"></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="center" />
                                                            </asp:TemplateField>
                        ...
                        <tr id="trSummary" runat="server" class="rowColors">
                            ...
                            <td align="center">
                                ...
                                <asp:Label ID="Label3" runat="server" Font-Names="Arial" Font-Size="14pt" ForeColor="Navy" Text="Shorted Summary" Font-Bold="True"></asp:Label>
                                <asp:GridView ID="gvCustomerSummary" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Font-Names="Arial" Font-Size="10pt" ForeColor="Black" GridLines="Vertical" OnRowDataBound="gvCustomerSummary_RowDataBound" OnSorting="gvCustomerSummary_Sorting" ShowFooter="True" Width="1100px">
                                    <AlternatingRowStyle BackColor="WhiteSmoke" />
                                    <Columns>
                                        <asp:TemplateField HeaderText="Name" SortExpression="Name">
                                            <HeaderStyle BackColor="#333333" CssClass="CenterAligner" Font-Bold="False" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Bottom" />
