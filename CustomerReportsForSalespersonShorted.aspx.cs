...
public partial class CustomerReportsForSalespersonShorted : System.Web.UI.Page
{
    //Full Report...
    ...
    private void RunReport(string sSalespersonUserID)
    {
        string sMsg = "";
    ...
    private void RunReportSummary(string sSalespersonUserID)
    {
        string sMsg = "";
    ...
    protected void btnStockCodeListPanel_Click(object sender, EventArgs e)
    {
        pnlSingleStockCode.Visible = false;
        pnlStockCodeRange.Visible = false;
        pnlEndCustomer.Visible = false;
