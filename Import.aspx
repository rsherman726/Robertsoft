<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Import.aspx.cs" Inherits="Import" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        <ContentTemplate>
            <table id="Table2" border="0" cellpadding="1" cellspacing="1" width="100%">
                <tr>
                    <td align="center">
                        <table id="Table1" border="0" cellpadding="1" cellspacing="1" width="500">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="16pt" ForeColor="Navy">IMPORT NEW PRICES FOR EMAILER</asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                ...
                                <td align="center">
                                    <table id="Table3" border="0" cellpadding="1" cellspacing="1" width="300">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:FileUpload ID="FileUploadExcel" runat="server" Width="300px" BackColor="LemonChiffon" CssClass="form-control" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <tr>
                    <td align="center">
                        <asp:HyperLink ID="hlTaxBillTemplate" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="11pt" ForeColor="Navy" NavigateUrl="~/Images/Templates/FelbroNewPriceTemplate.xlsx">New Prices Data Excel Template download</asp:HyperLink>
                    </td>
                </tr>
            </table>
