<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CustomerDailyNotesAdmin.aspx.cs" Inherits="CustomerDailyNotesAdmin" %>
                                                    ...
                                                    <table align="center" style="border-right: #000000 0px solid; border-top: #000000 0px solid; border-left: #000000 0px solid; border-bottom: #000000 0px solid; background-color: ghostwhite" width="700px">
                                                        <tr>
                                                            ...
                                                            <td style="width: 400px">
                                                                <asp:DropDownList ID="ddlSalesPerson" runat="server" BackColor="LemonChiffon" CssClass="form-control" Font-Bold="True" Font-Size="9pt" ForeColor="Black" AutoPostBack="True" OnSelectedIndexChanged="ddlSalesPerson_SelectedIndexChanged" Width="400px">
                                                        ...
                                                        <tr>
                                                            <td style="width: 5px">&nbsp;</td>
                                                            <td align="left">
                                                                <asp:ListBox ID="lbCustomers" runat="server" AutoPostBack="True" BackColor="LemonChiffon" CssClass="form-control input-sm" Font-Bold="True" Font-Names="arial" ForeColor="Black" Height="300px" OnSelectedIndexChanged="lbCustomers_SelectedIndexChanged" Width="600px" SelectionMode="Multiple" Font-Size="10pt"></asp:ListBox>
                                                            </td>
                                                            <td style="width: 15px">&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 5px">&nbsp;</td>
                                                            <td align="center">
                                                                <asp:LinkButton ID="lbSelectAll" runat="server" Font-Size="11pt" ForeColor="Navy" OnClick="lbSelectAll_Click" ValidationGroup="nothing">Select All</asp:LinkButton>
                                                                &nbsp;<asp:LinkButton ID="lbClearAll" runat="server" Font-Size="11pt" ForeColor="Navy" OnClick="lbClearAll_Click" ValidationGroup="nothing">Clear All</asp:LinkButton>
                                                            </td>
                                                            <td style="width: 15px">&nbsp;</td>
                                                        </tr>
                                                        <tr>
