...
public partial class TrendsReportPopup : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (Session["dtTrendsReportDollars"] != null)
            {
                DataTable dt = (DataTable)Session["dtTrendsReportDollars"];
    ...
    protected void imgExportExcel1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        dt = (DataTable)Session["dtTrendsReportDollars"];
        dt.TableName = "dtTrendsReportDollars";
        dtNew = dt.Copy();
        try
        {
        ...
        sFilesName = "PurchasingTrendsReportDollars" + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString();
