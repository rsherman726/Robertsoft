<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PlacedOrdersDetailsCommentOptionsAdmin.aspx.cs" Inherits="PlacedOrdersDetailsCommentOptionsAdmin" MaintainScrollPositionOnPostback="true" %>
                            ...
                            <tr>
                                <td class="hdr" align="center">
                                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="X-Large"
                                        Text="Place Orders Details Comment Options Admin" ForeColor="Black"></asp:Label></td>
                            </tr>
                            <tr>
                                    ...
                                    <asp:Panel ID="pnlMain" runat="server" Width="700px">
                                        <table align="center" style="border-right: #000000 0px solid; border-top: #000000 0px solid; border-left: #000000 0px solid; border-bottom: #000000 0px solid; background-color: ghostwhite" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtSearch" runat="server" AutoPostBack="True" BackColor="LemonChiffon" BorderWidth="2px" CssClass="form-control" ForeColor="Black"
                                                        OnTextChanged="txtSearch_TextChanged" ToolTip="This is an Auto Complete text box. Just fill in first, first-middle, or first-middle-lastname of the user's name."></asp:TextBox>
                                                    <ajaxToolkit:AutoCompleteExtender ID="txtSearch_AutoCompleteExtender" runat="server" CompletionInterval="0" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                                        CompletionListItemCssClass="autocomplete_listItem" CompletionSetCount="25" DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1" 
                                                        ServiceMethod="GetCompletionListCommentOption" ServicePath="" TargetControlID="txtSearch" UseContextKey="True">
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td align="left">
                                                    <asp:ListBox ID="lbCommentOptions" runat="server" AutoPostBack="True" BackColor="LemonChiffon" CssClass="form-control" Font-Bold="True" Font-Size="10pt" ForeColor="Black" Height="200px"
                                                        OnSelectedIndexChanged="lbCommentOption_SelectedIndexChanged"></asp:ListBox>
                                                </td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">&nbsp;</td>
                                                <td align="left">
                                                    <asp:Label ID="Label35" runat="server" Font-Bold="True" ForeColor="Black" Text="COMMENT OPTIONS:"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:TextBox ID="txtCommentOptions" runat="server" BackColor="LemonChiffon" BorderWidth="2px" CssClass="form-control" Font-Size="12pt" ForeColor="Black"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfvCommentOption" runat="server" ControlToValidate="txtCommentOptions" EnableClientScript="False" ErrorMessage="Comment Options is required." ValidationGroup="emp"><img src="Images/arrow_alert.gif" alt="arrow"/></asp:RequiredFieldValidator>
                                                </td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
