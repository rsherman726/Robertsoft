<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SalesOrderTrackerLite.aspx.cs" Inherits="SalesOrderTrackerLite" %>
                            ...
                            <tr>
                                <td class="hdr" align="center">
                                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="X-Large"
                                        Text="Open Orders - The Sales Order Tracker Lite" ForeColor="Black"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>
                                                    ...
                                                    <table id="tblColorsLegend" width="1050px">
                                                        ...
                                                        <%--    <tr>
                                                               <td align="center" style="width: 175px">
                                                                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Black" Text="Order is Ready" Width="125px"></asp:Label>
                                                            </td>

                                                            <td align="center" style="width: 175px">
                                                                <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Black" Text="Production Dates Confirmed" Width="175px"></asp:Label>
                                                            </td>
                                                            <td align="center" style="width: 175px">
                                                                <asp:Label ID="Label22" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Black" Text="Short or Late Shipping" Width="175px"></asp:Label>
                                                            </td>
                                                            <td align="center" style="width: 175px">
                                                                <asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Black" Text="Order Contains TBDs" Width="200px"></asp:Label>
                                                            </td> 
                                                             <td align="center" style="width: 175px;">
                                                                &nbsp;
                                                            </td> 
                                                             <td align="center" style="width: 175px">
                                                                <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Black" Text="Suspended" Width="125px"></asp:Label>
                                                            </td>
                                                        </tr>--%>
                                                        <tr>
                                        ...
                                        <asp:GridView ID="gvDetails" runat="server" CellPadding="4" ForeColor="#333333"
                                            ...
                                            <Columns>
                                               ...
                                               <asp:TemplateField HeaderText="<span style='color:Blue' class='fa fa-calendar'  title='Production Matrix'></span>">
                                                ...
                                                <asp:TemplateField HeaderText="<span style='color:GoldenRod' class='fa fa-sticky-note'  title='Special Instructions'></span>">
                                                    <ItemTemplate>
