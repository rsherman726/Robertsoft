<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrendsReportPopup.aspx.cs" Inherits="TrendsReportPopup" %>
...
<head runat="server">
    <title>Purchasing Trends Report</title>
            ...
            <asp:UpdatePanel ID="UpdatePanelPromo" runat="server">
                <ContentTemplate>
                    ...
                    <div style="text-align: left; padding: 10px; margin: 10px">
                        ...
                        <asp:Label ID="Label22" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="18pt" ForeColor="Navy">Purchasing Trends Report By Dollar Amount</asp:Label>
