<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OpenOrdersByStockCodeCustomer.aspx.cs" Inherits="OpenOrdersByStockCodeCustomer" MaintainScrollPositionOnPostback="true" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <table id="tblPopUpInventoryShortageReport" style="border: 1px solid black; font-size: 7pt; height: 350px; background-color: #FFFFFF;" width="100%" align="center">
                    <tr>
                        <td align="center">
                            <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Italic="False" Font-Size="16pt" ForeColor="Navy"> Open Orders by Stock code and Customer Report</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <table style="width: 800px">
                                ...
                                <tr>
                                    <td align="left">
                                        <asp:Label ID="Label70" runat="server" Font-Bold="True" Font-Size="12pt" ForeColor="Black" Text="End Customer:"></asp:Label>
                                    </td>
                                    <td align="center">
                                ...
                                <tr>
                                    <td align="left">&nbsp;</td>
                                    <td align="center">
                                        <asp:Label ID="lblStockCodeList" runat="server" Font-Bold="True" Font-Size="12pt" ForeColor="Navy" Text="Stock Code(s)"></asp:Label>
                                    </td>
                                    <td align="left" style="width: 5px">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td align="left">
                                        <asp:Label ID="Label78" runat="server" Font-Bold="True" Font-Size="12pt" ForeColor="Black" Text="End Customer StockCodes:" Width="225px"></asp:Label>
                                    </td>
                                    <td align="center">
                                        <asp:ListBox ID="lbParentStockCodeEndCustomer" runat="server" BackColor="LemonChiffon" Font-Size="9pt" ForeColor="Black" Height="100px" SelectionMode="Multiple" Width="446px"></asp:ListBox>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <br /><asp:LinkButton ID="imgExportExcelShortage" runat="server" CssClass="btn btn-success" ForeColor="White" OnClick="imgExportExcelShortage_Click" Width="200px"><i class="glyphicon glyphicon-export"></i></i>&nbsp;EXPORT TO EXCEL</asp:LinkButton>
                                        <br />
                                ...
                                <asp:GridView ID="gvInventoryShortageReport" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" Font-Size="9pt" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Description" SortExpression="Description">
                                            <HeaderStyle CssClass="CenterAligner" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblDescription" runat="server" CssClass="NoUnderline" Font-Bold="true" ForeColor="#00569D" Text='<%# Bind("Description") %>' Width="200px"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle BackColor="GhostWhite" HorizontalAlign="center" VerticalAlign="Top" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Shortage" SortExpression="Shortage">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblShortageYN" runat="server" Text='<%# Bind("ShortageYN") %>' Visible="false"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Notes">
                                           ...
                                           <asp:TemplateField HeaderText="Order<br>Total" SortExpression="OrderTotal">
                                            <HeaderStyle CssClass="CenterAligner" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblOrderAmount" runat="server" Text='<%# Bind("OrderAmount") %>' CssClass="NoUnderline" Font-Bold="true" ForeColor="#00569D"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle BackColor="GhostWhite" HorizontalAlign="center" VerticalAlign="Top" />
                                               <FooterTemplate>
                                                <asp:Label ID="lblOrderTotal" runat="server" CssClass="NoUnderline" Font-Bold="true" ForeColor="#00569D"></asp:Label>
                                            </FooterTemplate>
                                            <ItemStyle BackColor="GhostWhite" HorizontalAlign="center" VerticalAlign="Top" />
                                            <FooterStyle HorizontalAlign="center" />
                                        </asp:TemplateField>
