<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="WipCostReport.aspx.cs" Inherits="WipCostReport" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:UpdatePanel ID="UpdatePanelPromo" runat="server">
        <ContentTemplate>
            ...
            <table align="center" width="900">
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Cost Report" ForeColor="Black"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td></td>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td align="left">
                                                    ...
                                                    <asp:Label ID="lblDescriptionMain" runat="server" Font-Bold="True" Font-Size="11pt" ForeColor="Navy" Font-Names="Arial"></asp:Label>
                                                </td>
                ...
                <tr>
                    <td align="center">
                        <asp:CheckBox ID="chkCustomerReport" runat="server" Font-Size="9pt" ForeColor="Navy" Text="&nbsp;Launch Customer Report On StockCode" AutoPostBack="True" OnCheckedChanged="chkCustomerReport_CheckedChanged" /><br />
                    ...
                    <td align="center">
                        ...
                        <table>
                            <tr>
                                <td align="left">
                                    <!-- *** Begin Header Table *** -->
                                    <div id="DivHeader" style="vertical-align: top; width: 1050px; text-align: left;">
                            ...
                            <tr>
                                <td align="left">
                                    <asp:Panel ID="pnlGridView" runat="server" Height="300px" ScrollBars="Vertical" Visible="False">
                                        <div id="DivData" class="Container" style="vertical-align: top; height: 300px; width: 1010px;">
                                            <asp:GridView ID="gvReportCondensed" runat="server" AutoGenerateColumns="False" Font-Size="10pt"
                                                GridLines="Vertical" Width="1010px" ShowFooter="false" ShowHeader="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Recipe<br/>Cost">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRecipeCost" runat="server" Text='<%# Bind("RecipeMatCostTotUsedDisp") %>' Width="80px"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Pkg<br/>Cost">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPkgCost" runat="server" Text='<%# Bind("ParentMatCostTotAdjDisp") %>' Width="85px"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Labor<br/>OH">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblLaborCost" runat="server" Text='<%# Bind("TotLabCostDisp") %>' Width="85px"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Total">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblTotal" runat="server" Text='<%# Bind("TotCostDisp") %>' Font-Bold="true" Width="85px"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                </Columns>
                                    ...
                                    <asp:GridView ID="gvDetails1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Recipe<br/>Cost">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredientCost" runat="server" Text='<%# Bind("IngredientCost") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <%-- <asp:TemplateField HeaderText="Recipe<br/>Cost Per<br/>Uom">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredientCostPerUom" runat="server" Text='<%# Bind("IngredientCostPerUom") %>'></asp:Label>
                                                </ItemTemplate>                                               
                                            ...
                                            <asp:TemplateField HeaderText="Pkg<br/>Cost">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPkgCost" runat="server" Text='<%# Bind("PkgCost") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <%-- <asp:TemplateField HeaderText="Pkg<br/>Cost Per<br/>Uom">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPkgCostPerUom" runat="server" Text='<%# Bind("PkgCostPerUom") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" Width="70px" />                                              
                                            </asp:TemplateField>--%>
                                            <asp:TemplateField HeaderText="Labor<br/>Cost">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLaborCost" runat="server" Text='<%# Bind("LaborCost") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <%--<asp:TemplateField HeaderText="Labor<br/>Cost Per<br/>Uom">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLaborCostPerUom" runat="server" Text='<%# Bind("LaborCostPerUom") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" Width="70px" />                                              
                                            </asp:TemplateField>--%>
                                        </Columns>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Stock Code">
                                                ...
                                                <FooterTemplate>
                                                    ...
                                                    <br />
                                                    <asp:Label ID="lblCostPerPoundLabel" runat="server" Text="Cost per Uom"></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="What<br/> If Recipe<br/>Unit<br/> Cost">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWhatIfMatCostRSS" runat="server" Text='<%# Bind("WhatIfMatCostRSS") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblWhatIfMatCostRSSTotal" runat="server" Text="" Visible="false"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" VerticalAlign="Top" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Actual<br/>Unit<br/>Cost">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredMatCostUsedUnit" runat="server" Text='<%# Bind("ActualRecipeUnitCost") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="What<br/> If <br/>Recipe<br/> Cost">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWhatIfCostRSS" runat="server" Text='<%# Bind("WhatIfCost") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblWhatIfCostRSSTotal" runat="server" Text="" ForeColor="white"></asp:Label>
                                                    <br />
                                                    <asp:Label ID="lblCostPerPoundWhatIf" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" VerticalAlign="Top" />
                                            </asp:TemplateField>


                                            <asp:TemplateField HeaderText="Actual<br/>Recipe<br/> Cost">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredCost" runat="server" Text='<%# Bind("RecipeMatCostWhole") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblIngredCostTotal" runat="server" Text=""></asp:Label><br />
                                                    <asp:Label ID="lblCostPerPound" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" VerticalAlign="Top" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Avg<br/>Mat<br/>Cost" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAvgMatCost" runat="server" Text='<%# Bind("RecipeTrnValueUnit") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblAvgMatCostTotal" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" VerticalAlign="Top" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingred<br/>Qty<br/>Manufactured" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredQtyManufactured" runat="server" Text='<%# Bind("RecipeQtyManufactured") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblIngredQtyManufacturedTotal" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Wh" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredWh" runat="server" Text='<%# Bind("RecipeWh") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="IngredJob" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredJob" runat="server" Text='<%# Bind("RecipeJob") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingred<br/>Mat Cost<br/>Whole" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredMatCostWhole" runat="server" Text='<%# Bind("RecipeMatCostWhole") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblIngredMatCostWholeTotal" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingred<br/>Lab Cost<br/>Whole" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredLabCostWhole" runat="server" Text='<%# Bind("RecipeLabCostWhole") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblIngredLabCostWholeTotal" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingred<br/>Tot Cost <br/>Whole" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredTotCostWhole" runat="server" Text='<%# Bind("RecipeTotCostWhole") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterTemplate>
                                                    <asp:Label ID="lblIngredTotCostWholeTotal" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingred<br/>Used<br/> Factor" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredUsedFactor" runat="server" Text='<%# Bind("RecipeUsedFactor") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblIngredUsedFactorTotal" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingred<br/>Mat Cost<br/>Used Tot" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredMatCostUsedTot" runat="server" Text='<%# Bind("RecipeMatCostUsedTot") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblIngredMatCostUsedTotTotal" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Ingred<br/>Lab Cost<br/>Used Tot" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredLabCostUsedTot" runat="server" Text='<%# Bind("RecipeLabCostUsedTot") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblIngredLabCostUsedTotTotal" runat="server" Text="" Visible="false"></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingred<br/>Lab Cost<br/>Used Unit" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredLabCostUsedUnit" runat="server" Text='<%# Bind("RecipeLabCostUsedUnit") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label ID="lblIngredLabCostUsedUnitTotal" runat="server" Text=""></asp:Label>
                                                </FooterTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Recipe<br/>What If<br/>Mat Cost" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRecipeWhatIfMatCost" runat="server" Text='<%# Bind("RecipeWhatIfMatCost") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Recipe<br/>What If<br/>Lab Cost" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRecipeWhatIfLabCost" runat="server" Text='<%# Bind("RecipeWhatIfLabCost") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Recipe<br/>Unit Conv<br/>Fact" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRecipeUnitConvFact" runat="server" Text='<%# Bind("ParentUnitConvFact") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingred<br/>What If<br/>Mat Cost" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredWhatIfMatCost" runat="server" Text='<%# Bind("ParentWhatIfMatCost") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingred<br/>What If<br/>Lab Cost" Visible="false">
                                                <HeaderStyle CssClass="CenterAligner" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIngredWhatIfLabCost" runat="server" Text='<%# Bind("ParentWhatIfLabCost") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Right" />
                                                <FooterStyle BackColor="#333333" ForeColor="White" Font-Bold="True" HorizontalAlign="Right" />
                                            </asp:TemplateField>
