...
public partial class SalesOrderTrackerLite : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Session["SOT_TimerCheckedLite"] != null)
            {
                if ((bool)Session["SOT_TimerCheckedLite"] == true)
                {
    ...
    protected void gvRecord_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            ...
            case "ViewDetails":
                ...
                //AddGroupMembersToDeptCheckBoxes(); //Adds 2 seconds to load...
    ...
    protected void chkTimerOnOff_CheckedChanged(object sender, EventArgs e)
    {
        if (chkTimerOnOff.Checked)
        {
            Timer1.Enabled = true;
            Timer1.Interval = Convert.ToInt32(ddlInterval.SelectedValue);
            Session["SOT_TimerCheckedLite"] = true;
        }
        else
        {
            Timer1.Enabled = false;
            Session["SOT_TimerCheckedLite"] = false;
        }
    }
