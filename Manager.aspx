<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Manager.aspx.cs" Inherits="Manager" MaintainScrollPositionOnPostback="true"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //function unbindOBE() {
            //    $(window).unbind('onbeforeunload');//So we dont call the site.master onbeforeunload event when a popup is saved and closed...
            //}
