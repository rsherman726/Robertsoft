...
public partial class TrendsReportPopupSummary : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (Session["dtTrendsReportDollarsSummary"] != null)
            {
                DataTable dt = (DataTable)Session["dtTrendsReportDollarsSummary"];
    ...
    protected void imgExportExcel1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        dt = (DataTable)Session["dtTrendsReportDollarsSummary"];
        dt.TableName = "dtTrendsReportDollarsSummary";
        dtNew = dt.Copy();
        try
        {
        ...
        sFilesName = "PurchasingTrendsReportDollarsSummary" + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString();
